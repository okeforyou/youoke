            ...
            <div className="flex-1 flex flex-col min-w-0 relative bg-white dark:bg-zinc-950 transition-colors">
                ...
                {mounted && (
                    <div
                        ...
                        className={clsx(
                            "transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] z-[100] max-lg:overflow-visible lg:overflow-hidden lg:border-l lg:border-gray-200 lg:dark:border-zinc-800 shrink-0",
                        ...
                        <div className={clsx(
                            ...
                            {layoutMode !== 'fullscreen' && (
                                <>
                                    <div className="lg:hidden flex flex-col bg-white dark:bg-zinc-950 border-b border-gray-100 dark:border-zinc-900 shadow-sm relative z-[120] transition-colors">
