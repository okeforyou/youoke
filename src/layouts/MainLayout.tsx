            ...
            <div className="flex-1 flex flex-col min-w-0 relative bg-white z-10">
                ...
                <main className="flex-1 overflow-y-auto relative flex flex-col bg-gray-50/20">
                    <div className="w-full pb-20">
                        ...
                        {/* Desktop Header */}
                        <header className="hidden lg:flex h-20 items-center justify-between px-8 border-b border-gray-100/50 bg-white/60 backdrop-blur-2xl sticky top-0 z-30">
                        ...
                        {layoutMode !== 'fullscreen' && (
                            <div className="lg:hidden flex flex-col pb-2.5 bg-white/60 backdrop-blur-3xl border-b border-gray-100/50 shadow-sm sticky top-0 z-30">
