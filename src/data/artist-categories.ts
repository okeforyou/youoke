...
export const ARTIST_CATEGORIES: ArtistCategory[] = [
  ...
  },
  {
    ...
    artists: [
      ...
      { name: 'ซาร่าห์ ศโลลา (Sarah Salola)' }, { name: 'ยัวร์มู้ด (YourMOOD)' }, { name: 'ส้ม มารี (Zom Marie)' }, { name: 'โอ๊ต ปราโมทย์ (Oat Pramote)' },
      { name: 'ป๊อบ ปองกูล (Pop Pongkool)' }, { name: 'สิงโต นำโชค (Singto Numchok)' }, { name: 'เคลียร์ (Klear)' }, { name: 'ลิปตา (Lipta)' },
      { name: 'โนวันเอลส์ (No One Else)' }, { name: 'ซีซันไฟฟ์ (Season Five)' }, { name: 'รูมเธอร์ตี้ไนน์ (Room39)' }, { name: 'มีน (Mean)' },
      { name: 'Fellow Fellow' }, { name: 'เทอร์โบ (Txrbo)' },
      { name: 'สรัล (Saran)' }, { name: 'สไปร์ท (SPRITE)' }, { name: '1MILL' }, { name: 'Youngohm' },
    ]
  },
  {
    id: 'rock-thai',
    ...
    artists: [
      ...
      { name: 'พั้นซ์ วรกาญจน์ (Punch)' }, { name: 'แบล็คเฮด (Blackhead)' }, { name: 'สไมล์ บัฟฟาโล่ (Smile Buffalo)' }, { name: 'วาย น็อต เซเว่น (Y Not 7)' },
      { name: 'ฟลาย (Fly)' }, { name: 'แท็กซี่ (Taxi)' }, { name: 'กะลา (Kala)' }, { name: 'แฮงแมน (Hangman)' }, { name: 'เดอะ มูส (The Mousses)' },
      { name: 'เดอะ เยอร์ส (The Yers)' }, { name: 'โลโมโซนิก (Lomosonic)' }, { name: 'อีโบล่า (Ebola)' }, { name: 'เปเปอร์ เพลนส์ (Paper Planes)' },
      { name: 'บอมบ์ แอท แทร็ค (Bomb at Track)' }, { name: 'ไททศมิตร (TaitosmitH)' }, { name: '25ชั่วโมง (25hours)' }, { name: 'มัสเกตเทียส์ (Musketeers)' }, 
      { name: 'มายด์ (Mild)' }, { name: 'เก็ตสึโนวา (Getsunova)' }, { name: 'เจ็ตเซ็ตเตอร์ (Jetset\'er)' },
      { name: 'ไอ-แซค (I-Zax)' }, { name: 'โซคูล (So Cool)' }, { name: 'แพนเค้ก (Pancake)' },
      { name: 'นูโว (Nuvo)' }, { name: 'ไมโคร (Micro)' }, { name: 'เอสดีเอฟ (SDF)' }, { name: 'โน มอร์ เทียร์ (No More Tear)' },
    ]
  },
  {
    id: 'retro-hits',
    ...
    artists: [
      ...
      { name: 'นัท มีเรีย' }, { name: 'ทู (Two)' }, { name: 'ยูเอชที (UHT)' }, { name: 'บอยสเก๊าท์ (Boyscout)' },
      { name: 'ด็อกเตอร์ คิดส์ (Dr. Kids)' }, { name: 'บับเบิ้ล เกิร์ลส์ (Bubble Girls)' }, { name: 'ซาซ่า (Zaza)' }, { name: 'เอ็กซ์ทรี ซูเปอร์แก๊งค์ (X3 Super Gang)' },
      { name: 'มิสเตอร์ทีม (Mr.Team)' }, { name: 'ดับเบิ้ล ยู (Double U)' }, { name: 'เซเว่น (Seven)' },
      { name: 'ดีทูบี (D2B)' }, { name: 'เกิร์ลลี่ เบอร์รี่ (Girly Berry)' },
      { name: 'ทัช ณ ตะกั่วทุ่ง' }, { name: 'โดม ปกรณ์ ลัม' },
      { name: 'คีรีบูน' }, { name: 'อินคา' }, { name: 'นรีกระจ่าง' },
  ...
  },
  {
    ...
    artists: [
      ...
      { name: 'ไอซ์ ศรัณยู' }, { name: 'บี-โอ-วาย (B.O.Y)' }, { name: 'ชิน ชินวุฒิ' }, { name: 'บี้ สุกฤษฎิ์ (Bie the Star)' },
      { name: 'แก้ม วิชญาณี' }, { name: 'รุจ ศุภรุจ' }, { name: 'กัน นภัทร' }, { name: 'โตโน่ ภาคิน' },
      { name: 'สิงโต นำโชค' }, { name: 'คิส มี ไฟฟ์ (Kiss Me Five)' }, { name: 'เอ็กซ์ ไอ เอส (XIS)' }, { name: 'แคนดี้ มาเฟีย (Candy Mafia)' },
      { name: 'จี-ทเวนตี้ (G-Twenty)' }, { name: 'โอลีฟส์ (Olives)' }, { name: 'ชูการ์ อายส์ (Sugar Eyes)' }, 
      { name: 'แคท-แพท (Kat-Pat)' }, { name: 'สปลิท (Split)' }, { name: 'มิล่า (Mila)' }, { name: 'พิมมี่ (Pimmy)' }, { name: 'ชิลลี่ ไวท์ ช็อค (Chilli White Choc)' }, { name: 'ซิสก้า (Siska)' },
      { name: 'เซเว่น เดย์ส (Seven Days)' }, { name: 'ธามไท (Timethai)' }, { name: 'จินนี่ (Jinny)' },
    ]
  },
  {
    id: 'rnb-soul-th',
    ...
    artists: [
      ...
      { name: 'แก้ม วิชญาณี (Gam)' }, { name: 'นิว-จิ๋ว (New-Jiew)' }, { name: 'ดา เอ็นโดรฟิน' },
      { name: 'ลุลา (Lula)' }, { name: 'ตู๋ ภพธร' }, { name: 'แสตมป์ อภิวัชร์' }, { name: 'ลิเดีย ศรัณย์รัชต์' },
      ...
      { name: 'โก้ มิสเตอร์แซกแมน' }, { name: 'ว่าน ธนกฤต' },
      { name: 'โบ สุนิตา' }, { name: 'ปาน ธนพร' },
      { name: 'ทอม อิศรา' }, { name: 'โรส ศิรินทิพย์' }, { name: 'นท พนายางกูร' }, { name: 'มียู (Meyou)' },
      { name: 'กวิน ดี (Gavin D)' }, { name: 'เดอะ ทอยส์ (The Toys)' }, { name: 'โมนิก (Monik)' }, { name: 'แว่นใหญ่ (Wanyai)' },
      { name: 'มาเรียม บีไฟฟ์ (Mariam B5)' }, { name: 'อีทีซี (ETC.)' }, { name: 'บอย พีซเมคเกอร์ (Boy Peacemaker)' }, { name: 'ต้น ธนษิต (Ton Thanasit)' },
    ]
  },
  {
    id: 'indie-th',
    ...
    artists: [
      ...
      { name: 'กรีซซี่ คาเฟ่ (Greasy Cafe)' }, { name: 'เดสก์ท็อป เออร์เรอร์ (Desktop Error)' }, { name: 'จุลโหฬาร' }, { name: 'อภิรมย์' },
      { name: 'เยนเต็ด (Yented)' }, { name: 'เทเล็กซ์ เทเล็กซ์ (TELEx TELEXs)' }, { name: 'พลาสติก พลาสติก (Plastic Plastic)' }, { name: 'ภูมิ วิภูริศ (Phum Viphurit)' },
  ...
  },
  {
    ...
    artists: [
      ...
      { name: 'รวงทอง ทองลั่นธม' }, { name: 'จันทนีย์ อูนากูล' }, { name: 'ดาวใจ ไพจิตร' },
  ...
  },
  {
    ...
    artists: [
      ...
      { name: 'บิ๊กแบง (BIGBANG)' }, { name: 'ซูเปอร์จูเนียร์ (Super Junior)' }, { name: 'ชายนี่ (SHINee)' }, { name: 'ทูพีเอ็ม (2PM)' }, { name: 'ไอลิท (ILLIT)' }, { name: 'ไรซ์ (RIIZE)' }, 
      { name: 'ทีดับบลิวเอส (TWS)' }, { name: 'บอยเนกซ์ดอร์ (BOYNEXTDOOR)' },
  ...
  },
  {
    ...
    artists: [
      ...
      { name: 'ไมเคิล แจ็คสัน (Michael Jackson)' }, { name: 'ลานา เดล เรย์ (Lana Del Rey)' }, { name: 'อาร์กติก มังกีส์ (Arctic Monkeys)' },
      { name: 'เดอะ เนเบอร์ฮูด (The Neighbourhood)' }, { name: 'กันส์แอนด์โรสเซส (Guns N\' Roses)' },
    ]
  }
];
