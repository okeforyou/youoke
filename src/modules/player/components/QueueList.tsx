...
function SortableQueueItem({ video, index, actualIndex, onRemove, onPlay }: SortableItemProps) {
    ...
    return (
        ...
        >
            ...
            <div className="flex-1 flex items-center gap-4 rounded-xl border border-gray-100 dark:border-zinc-800/80 transition-all overflow-hidden hover:border-primary/50 bg-white dark:bg-zinc-900/40 shadow-sm hover:shadow-md hover:-translate-y-0.5">
