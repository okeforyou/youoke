...
export const NotificationToast: React.FC<NotificationToastProps> = ({ message, sub, isVisible }) => {
    return (
        <div className={clsx(
            ...
            <div className="bg-white/10 backdrop-blur-md border border-white/20 p-3 rounded-xl shadow-2xl flex items-center gap-3 min-w-[260px]">
                <div className="w-10 h-10 rounded-full bg-primary flex items-center justify-center shrink-0 shadow-lg shadow-primary/30 animate-bounce">
