        ...
        <header className="hidden lg:flex h-20 items-center justify-between px-8 border-b border-gray-100 dark:border-zinc-800 bg-white dark:bg-zinc-950 sticky top-0 z-20 transition-all">
            <div className="flex-1 max-w-2xl relative group flex gap-2">
                {user ? (
                    ...
                    <div className="flex-1 flex items-center justify-between bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 rounded-2xl px-5 py-3 shadow-lg transform transition-all hover:scale-[1.01]">
                        <div className="flex flex-col">
                            <div className="flex items-center gap-2">
                                <span className="text-base font-black text-white tracking-tight drop-shadow-sm">🚀 ทดลองใช้งานระบบตัดเสียงร้อง AI ฟรี 1 วัน!</span>
                                <span className="px-2 py-0.5 bg-yellow-400 text-yellow-900 text-[10px] font-black rounded-full uppercase tracking-wider animate-pulse shadow-sm">Special</span>
                            </div>
                            <span className="text-[11px] font-medium text-white/90 leading-tight mt-1 max-w-md">
                                เพียงเข้าสู่ระบบด้วยบัญชี Google เพื่อรับสิทธิ์และยืนยันการใช้งานสื่อส่วนบุคคล (Personal Use)
                            </span>
                        </div>
                        <button
                            onClick={signInWithGoogle}
                            className="flex items-center gap-2 px-5 py-2.5 bg-white hover:bg-gray-50 text-sm font-black text-gray-800 rounded-xl shadow-[0_4px_12px_rgba(0,0,0,0.15)] hover:shadow-[0_6px_16px_rgba(0,0,0,0.2)] transition-all active:scale-95 border-2 border-white/20"
                        >
