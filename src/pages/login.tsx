                ...
                <div className="transition-all">
                    <div className="mb-8 text-center">
                        ...
                        <p className="text-gray-500 text-[13px] font-medium">
                            {isLogin ? (
                                <>ยังไม่มีบัญชี? <button onClick={() => setIsLogin(false)} className="text-primary font-bold hover:underline decoration-1 underline-offset-4">สร้างบัญชีใหม่</button></>
                            ) : (
                                <>มีบัญชีอยู่แล้ว? <button onClick={() => setIsLogin(true)} className="text-primary font-bold hover:underline decoration-1 underline-offset-4">เข้าสู่ระบบที่นี่</button></>
                            )}
                        </p>
                    </div>
                    ...
                    <form className="space-y-4" onSubmit={handleSubmit}>
                        {(error || localError) && (
                            <div className="bg-red-50 border border-red-100 text-red-600 text-[11px] font-bold p-3 rounded-2xl flex items-center gap-3 animate-in shake duration-500">
