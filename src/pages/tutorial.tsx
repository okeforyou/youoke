...
export default function TutorialPage() {
    ...
    const content = {
        ...
        remote: [
            { step: 1, title: "สแกน QR Code", desc: "ใช้มือถือสแกนคิวอาร์โค้ดที่แสดงอยู่หน้าจอเรือเล่น (Player)" },
            { step: 2, title: "เชื่อมต่อสำเร็จ", desc: "มือถือของคุณจะเข้าสู่โหมดรีโมท พร้อมสั่งงานเพลงได้ทันที" },
            { step: 3, title: "สั่งเพลงไร้สาย", desc: "เลือกเพลงและคุมเครื่องเล่นได้จากทุกที่ในรัศมีบ้านคุณ" },
        ],
        display: [
            { step: 1, title: "ต่อสาย HDMI (Dual Screen)", desc: "เชื่อมสาย HDMI จากคอมพิวเตอร์เข้าทีวี ตั้งค่า Display เป็น 'Extend' แล้วลากหน้าต่าง Player ไปไว้จอทีวีเพื่อแยกจอเนื้อร้อง" },
            { step: 2, title: "Google Cast (ไร้สาย)", desc: "ใช้ Chrome Browser และกดไอคอน Cast ในตัวเล่น เลือกชื่อ Smart TV ของคุณเพื่อส่งภาพและเสียงขึ้นจอใหญ่โดยไม่ใช้สาย" },
            { step: 3, title: "เล่นบนเบราว์เซอร์ทีวี", desc: "เปิดเว็บ play.okeforyou.com บนทีวีโดยตรง แล้วใช้มือถือสแกน QR Code เพื่อสั่งเพลงแบบไร้ขีดจำกัด" },
        ],
        queue: [
