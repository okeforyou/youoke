...
export default function TutorialPage() {
    ...
    const content = {
        ...
        display: [
            { step: 1, title: "ลากหน้าต่างไปจอแยก", desc: "เปิดตัวเล่น (Player) และลากหน้าต่างไปที่จอทีวีหรือโปรเจกเตอร์" },
            { step: 2, title: "ใช้ระบบ Cast", desc: "กดไอคอน Cast ในตัวเล่น เพื่อส่งภาพขึ้น Smart TV แบบไร้สาย" },
            { step: 3, title: "ความชัดระดับ Full HD", desc: "เพลิดเพลินกับมิวสิควิดีโอคุณภาพสูงเหมือนอยู่ในร้านคาราโอเกะ" },
        ],
        queue: [
