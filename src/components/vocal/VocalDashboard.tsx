...
export function VocalDashboard() {
  ...
  return (
    <div className="flex h-full w-full text-text-base overflow-hidden selection:bg-primary/10 bg-white dark:bg-zinc-950 rounded-b-3xl">
      {/* Main Content Area */}
