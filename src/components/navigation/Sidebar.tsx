            ...
            >
                ...
                <Link href="/creator" 
                    className={clsx(
                        ...
                        isSidebarCollapsed ? "justify-center p-3 rounded-xl" : "gap-3 px-4 py-3 rounded-2xl",
                        (router.pathname === '/creator') ? "bg-primary text-white translate-x-1" : "text-black dark:text-zinc-400 hover:bg-gray-100/50 dark:hover:bg-zinc-900/50 hover:text-black dark:hover:text-white"
                    )}
                    title={isSidebarCollapsed ? "Creator Studio" : ""}
                >
                    <Sparkles className={clsx("w-[22px] h-[22px]", (router.pathname === '/creator') ? "text-white" : "text-black dark:text-zinc-400")} /> 
                    <span className={clsx("transition-all duration-300 whitespace-nowrap", isSidebarCollapsed ? "opacity-0 w-0 overflow-hidden" : "opacity-100")}>
                        Creator Studio
                    </span>
                </Link>
