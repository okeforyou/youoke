    ...
    return (
        <aside className="hidden lg:flex w-[260px] bg-white border-r border-gray-200 flex-col shrink-0 z-30">
            ...
            >
                ...
                <button onClick={() => handleNav(1, 'home')} className={clsx("w-full flex items-center gap-3 px-4 py-3 rounded-2xl transition-all font-bold duration-300 text-sm", (router.pathname === '/' && activeIndex === 1) ? "bg-primary text-white shadow-lg shadow-primary/25 translate-x-1" : "text-black hover:bg-gray-100/50 hover:text-black")}>
