                            ...
                            <div className={clsx(
                                ...
                                {item.id === 5 ? (
                                    (() => {
                                        ...
                                        if (photoURL && user) {
                                            return <img src={photoURL} className={clsx("w-6 h-6 rounded-full object-cover shrink-0 border transition-transform duration-300", isActive ? "scale-110 border-primary" : "border-transparent")} alt="Profile" />;
                                        }
