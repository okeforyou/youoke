...
- [x] `src/modules/player/components/FullscreenControlBar.tsx`: Integrate lyrics, guide vocals, and popover mixer controls directly into the fullscreen controller, removing legacy offset adjusters.
