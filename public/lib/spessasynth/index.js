...
import { KeyModifier } from "./core.js";
...
// src/synthesizer/audio_effects/basic_effects_processor.ts
...
// src/synthesizer/audio_effects/chorus.ts
var NODES_AMOUNT = 4;
var DEFAULT_DELAY = 0.03;
var DELAY_VARIATION = 0.013;
var STEREO_DIFF = 0.03;
var OSC_FREQ = 0.2;
var OSC_FREQ_VARIATION = 0.05;
var OSC_GAIN = 3e-3;
var DEFAULT_CHORUS_CONFIG = {
...
var ChorusProcessor = class extends BasicEffectsProcessor {
  chorusLeft = [];
  chorusRight = [];
  /**
   ...
   */
  constructor(context, config = DEFAULT_CHORUS_CONFIG) {
  ...
  createChorusNode(freq, delay, list, input, output, outputNum, config) {
...
var ReverbProcessor = class extends BasicEffectsProcessor {
   ...
   */
  constructor(context, config = DEFAULT_REVERB_CONFIG) {
    ...
    if (reverbBuffer) {
      ...
      this.isReady = new Promise((r) => r(reverbBuffer));
    } else {
...
import { ChannelSnapshot, SynthesizerSnapshot } from "./core.js";
...
import { SpessaSynthProcessor, SpessaSynthSequencer } from "./core.js";
...
import { SoundBankLoader as SoundBankLoader2 } from "./core.js";
...
import { BasicMIDI, MIDITrack } from "./core.js";
  ...
  handleMessage(m) {
    ...
    switch (m.type) {
      ...
      case "setChannelVibrato":
        ...
        } else if (m.data.rate === ALL_CHANNELS_OR_DIFFERENT_ACTION2) {
...
import { BasicSoundBank } from "./core.js";
...
import { BasicMIDI as BasicMIDI3 } from "./core.js";
...
var WorkerSynthesizerCore = class extends BasicSynthesizerCore {
  ...
  renderAndSendChunk() {
    ...
    const data = new Float32Array(BLOCK_SIZE2 * 36);
    let byteOffset = 0;
    const revR = new Float32Array(data.buffer, byteOffset, BLOCK_SIZE2);
    byteOffset += byteStep;
    const revL = new Float32Array(data.buffer, byteOffset, BLOCK_SIZE2);
    const rev = [revL, revR];
    byteOffset += byteStep;
    const chrL = new Float32Array(data.buffer, byteOffset, BLOCK_SIZE2);
    byteOffset += byteStep;
    const chrR = new Float32Array(data.buffer, byteOffset, BLOCK_SIZE2);
    const chr = [chrL, chrR];
    const dry = [];
    for (let i = 0; i < 16; i++) {
      byteOffset += byteStep;
...
import { audioToWav } from "./core.js";
...
import { SpessaSynthCoreUtils as util3 } from "./core.js";
...
import { SpessaSynthCoreUtils as SpessaSynthCoreUtils5 } from "./core.js";
